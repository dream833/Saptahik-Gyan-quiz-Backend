...
<head>
    ...
    <title>Daily Mock Test Result - WB Admin</title>
    <style>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="dailymockresult.php" class="active"><span class="nav-icon"><svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg></span>Daily Mock Test Result</a>
    ...
    <main class="main-content">
        <header class="topbar">
            ...
            <h1 class="page-title">Daily Mock Test Result</h1>
        ...
        <div class="page-content">
            <div class="page-header">
                <h1>Daily Mock Test Result</h1>
                <p>View daily mock test results</p>
            </div>
            <div class="placeholder-card">
                <div class="placeholder-icon">
                    <svg viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>
                </div>
                <h3>Daily Mock Test Result</h3>
                <p>Daily mock test results will be displayed here.</p>
            </div>
        </div>
    </main>
